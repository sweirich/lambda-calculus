...
Definition var_x := Atom.fresh nil.
Definition var_y := Atom.fresh (var_x :: nil).
...
Proof.
  ...
  - specialize (f v_wrong ltac:(reflexivity)).
    apply wrong_not_Fn in f. done.
